    ...
    <div className='w-full p-4 bg-white rounded-3xl'>
      <div className='flex flex-wrap items-center justify-between gap-2 mb-8 lg:gap-0 lg:flex-nowrap'>
        ...
        <div className='flex gap-4 '>
          <div className='flex items-center rounded-lg' style={{ background: "#f1f1f1" }}>
            <span className='px-2 py-1 text-xs text-slate-400'>Rain precipitation
            </span>
          ...
          <div className='flex items-center rounded-lg' style={{ background: "#f1f1f1" }}>
            <span className='px-2 py-1 text-xs text-black'>Next days
            </span>
